...
def projects_page(request: Request):
    return templates.TemplateResponse(
        "projects.html", {"request": request, "active_page": "projects"}
    )
...
def faults_page(request: Request):
    return templates.TemplateResponse(
        "faults.html", {"request": request, "active_page": "faults"}
    )
...
def knowledge_page(request: Request):
    return templates.TemplateResponse(
        "knowledge_base.html", {"request": request, "active_page": "knowledge"}
    )
...
def fault_detail(request: Request, fault_id: int):
    return templates.TemplateResponse(
        "fault_detail.html",
        {"request": request, "fault_id": fault_id, "active_page": "faults"},
    )
...
def kanban_page(request: Request):
    return templates.TemplateResponse(
        "kanban.html", {"request": request, "active_page": "kanban"}
    )
